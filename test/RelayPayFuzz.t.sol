...
contract RelayPayFuzzTest is Test {
    ...
    function testFuzz_CreateInvoiceFixedXrp(
    ...
    function testFuzz_FtsoPricingConversion(
    ...
    function testFuzz_ExactPaymentFulfillment(
        uint256 drops,
        uint64 blockOffset
    ) public {
